    ...
    container.innerHTML = `
      <section class="px-4 py-8 sm:px-6 animate-fadeIn">
        <div class="mx-auto max-w-2xl text-center">
          <h3 class="section-label">${t('app.download_history')}</h3>
        ...
        <div class="space-y-3">
          ${state.history.map((item, i) => `
            <div class="history-item animate-fadeIn" style="animation-delay: ${i * 40}ms">
              <div class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl" style="background: ${item.platformColor}15; box-shadow: var(--neu-raised-sm)">
